...
- Not done yet: code signing with an Apple Developer ID and notarisation (so other people's Macs do not warn), a universal (Intel + Apple silicon) build, a release-pipeline job that attaches the app, and a Windows installer.
