...
T.run(async () => {
  ...
  const general = { letters: 8, words: 10, sentences: 8, basics: 10 };      // core plus the bonus levels every language has
  ...
  T.check("German: letters 9, words 12, sentences 10, lessons 12", german.letters === 9 && german.words === 12 && german.sentences === 10 && german.basics === 12, JSON.stringify(german));
